  ...
  return (
    <div className="fixed top-0 left-0 z-20 bg-white w-full pt-24 h-screen flex flex-col">
      <nav className="flex-1 flex flex-col gap-2 px-6">
        ...
        <Link href="#experience" className="font-space text-2xl text-black/70 hover:text-black transition-colors py-3">
          {t.header.nav.experience}
        </Link>
        <Link href="#portfolio" className="font-space text-2xl text-black/70 hover:text-black transition-colors py-3">
          {t.header.nav.portfolio}
        </Link>
        <Link href="#contacts" className="font-space text-2xl text-black/70 hover:text-black transition-colors py-3">
          {t.header.nav.contacts}
        </Link>
      </nav>

      <div className="px-6 pb-10">
        <p className="font-space text-sm text-black/40 uppercase tracking-wider mb-4">Connect</p>
